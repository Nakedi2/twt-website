...
const initialTestimonials: Testimonial[] = [
  {
    id: 1,
    name: "Dr. Mamokete Matsebe",
    role: "Head of Department",
    company: "Gauteng Department of Education",
    content:
      "TWT has revolutionised how our teachers approach digital learning. The platform is intuitive, accessible, and perfectly suited to the South African classroom environment.",
    rating: 5,
    featured: true,
  },
  {
    ...
    name: "James Nkosi",
    role: "Principal",
    company: "Mamelodi Secondary School",
    content:
      "Since implementing TWT's digital textbooks, our matric pass rate improved by 18%. The students are more engaged and the teachers love the analytics dashboard.",
    rating: 5,
    featured: true,
  },
  {
    ...
    company: "UNESCO South Africa",
    content:
      "An exceptional example of homegrown EdTech innovation. TWT addresses real challenges faced by South African schools with solutions that actually work.",
    rating: 5,
    featured: false,
  },
  {
    id: 4,
    name: "Prof. Hendrik Pretorius",
    role: "Dean of Education",
    company: "University of Pretoria",
    content:
      "Our research partnership with TWT has yielded remarkable insights into effective digital learning strategies for multilingual classrooms.",
    rating: 4,
    featured: false,
  },
  {
    ...
    role: "Parent & School Governing Body",
    company: "Soweto Primary School",
    content:
      "My children finally have access to quality learning materials at home. The offline feature is a game changer for families without reliable internet.",
    rating: 5,
    featured: true,
  },
  {
    ...
    content:
      "TWT's technical architecture is impressive. Their offline-first approach and commitment to local languages sets them apart in the African EdTech space.",
    rating: 4,
    featured: false,
  },
];
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      if (editing) {
        ...
        setTestimonials([...testimonials, { id: data?.id || Date.now(), ...form }]);
      }
      setShowModal(false);
    } catch {
      // handle silently
        ...
        {testimonials.map((t) => (
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              {t.featured && (
                <span className="px-2 py-0.5 bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400 text-xs rounded-full font-medium">
                  Featured
                </span>
              )}
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400 flex-1 mb-4 italic">
